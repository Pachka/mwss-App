...
class(params$control_traj) %>% match(., c("ISO", "SA", "ScreenP", "ScreenH", "TestSympP", "TestSympH")) %>% 
  c("confinement/contact restriction to detected patients", 
    " implementation of a screening area at patient admission including contact restriction/clinical examination/test",
    ...
    " positive probability to test symptomatic patients",
    " positive probability to test symptomatic healthcare workers")[.] %>% paste(., collapse = " / "),".")
```
