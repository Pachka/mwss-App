...
cat('
This report presents synthetic results of', length(params$trajmwss), 'simulations run for an',  params$clustering, 'hospital structure including', length(params$ward_names), 'wards distributed over five buildings, and connected through healthcare workers.')

if(is.null(params$clustering))
cat('
This report presents synthetic results of', length(params$trajmwss), 'simulations run for an hospital structure including', length(params$ward_names), 'wards distributed over five buildings, and connected through healthcare workers.')
```
...
The baseline considered R0 was ``r if(params$disease == "Covid") 13 else if(params$disease == "Influenza") 1.3   # params$gdata["pconta"]*(8 * (30 / 60 / 24) * params$gdata["prev"]/params$gdata["hinc"])``.
